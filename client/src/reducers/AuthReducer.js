const authReducer = (state = { authData: null, loading: false, error: false, updateLoading: false },action) => {
  ...
  console.log("Reducer User Data:", action.payload); // Add this line for debugging
  return { ...state, viewedUserProfile: action.payload };
  
      case "FETCH_USER_PROFILE_FAIL":
        return { ...state, error: "Failed to fetch user profile" };
